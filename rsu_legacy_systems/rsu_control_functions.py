...
def init_gpio():
    ...
    if (RASPBERRY==True):
        ...
        if (app_conf.debug_gpio):
            print ('gpio control functions:  init_gpio  green ', green, 'OUT LOW')
            print ('gpio control functions:  init_gpio  yellow ', yellow, 'OUT LOW')
            print ('gpio control functions:  init_gpio  red ', red, 'OUT LOW')
